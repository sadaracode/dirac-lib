...
public:
	...
	double Ej1 = 2 * PI * 5000; //MJ
	double Ej2 = 2 * PI * 5000;
	double Ej_sigma = Ej1 + Ej2;
	double Cj = 0.0074 * pow(10, -6); //Josephson capacitance in microFarad

	double Cg = 0.0626 * pow(10, -6); //additional capacitance in microFarad
